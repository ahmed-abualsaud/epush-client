    ...
    <div class="flex flex-col items-center rounded-xl bg-white shadow-xl w-[480px]">
        <div class="flex flex-col items-center self-stretch gap-4 pt-6 pb-5 px-6 bg-white rounded-t-xl border-b">
            ...
            <div class="flex flex-col items-center self-stretch gap-1">
                <span class="self-stretch text-center text-gray-900 text-lg font-semibold">Are you sure to delete<br>these selected messages?</span>
                <span class="self-stretch text-center text-gray-600 text-sm">You will delete these selected messages<br>from scheduled messages</span>
            </div>
        </div>

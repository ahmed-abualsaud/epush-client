...
<AddMessageModal modalName="no-credit">
    <NoData message="You don't have enaugh credit!" description="A new order is required so you can have credit for pushing messages" />

<script>
    ...
    const toggleFilter = () => {
        ...
        filterButton.querySelector(".open-filter").classList.toggle("flex")
        filterButton.querySelector(".open-filter").classList.toggle("hidden")
        filterButton.querySelector(".close-filter").classList.toggle("flex")
        filterButton.querySelector(".close-filter").classList.toggle("hidden")
    }
</script>

<div class="flex items-center gap-3">
    <div class="flex items-center self-stretch w-[400px] gap-2 rounded-lg border border-gray-300 bg-white shadow-sm">
    ...
    <button bind:this={filterButton} on:click={toggleFilter}>
        <div class="open-filter flex justify-center items-center gap-2 py-2.5 px-4 h-11 rounded-lg border border-gray-300 bg-white shadow-sm hover:bg-primary-50">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
        ...
        <div class="close-filter hidden justify-center items-center gap-2 py-2.5 px-4 h-11 rounded-lg border border-gray-300 bg-white shadow-sm hover:bg-primary-50">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
